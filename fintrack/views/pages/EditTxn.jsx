    ...
    return (
        <html lang="en">
          <head>
            ...
            <form method="POST" action={"/home/"+this.props.username[0]+"/"+this.props.txnData.rows[0].id+'/?_method=PUT'}>
              ...
              <div class="form-group">
                ...
                <input type="date" class="form-control" id="exampleFormControlInput1" value={this.props.txnData.rows[0].transaction_date} name="transaction_date"/>
              </div>
              <div class="form-group">
