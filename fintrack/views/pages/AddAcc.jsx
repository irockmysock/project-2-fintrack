          ...
          <body>
            ...
            <div class="container-fluid">
                ...
                <div className="text-center">
                    <h1 className="text-info">Add New Account</h1>
                </div>

                <form method="POST" action={"/home/"+this.props.username[0]+"/newAccount"}>

                  <div class="form-group">
                    <label for="exampleFormControlInput1">Account Name</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Card Name" name="type"/>
                  </div>

                  <div class="form-group">
                    <label for="exampleFormControlInput1">Card Image</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Card Image URL" name="type_icon"/>
                  </div>
